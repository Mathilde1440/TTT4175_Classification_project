...
def solve_task_one(k_neighbors=1,folder_path=None,figure_names=None, save_figures=False):
...
error_1 = solve_task_one(k_neighbors=7,
                         folder_path = folderPath,
                         figure_names=fig_labels_task1,
                         save_figures=True )


error_2A = solve_task_two(folder_path = folderPath,
                          figure_names=fig_labels_task2A,
                          save_figures=True)

error_2B = solve_task_two(k_neighbors=7, 
                          folder_path = folderPath,
                          figure_names=fig_labels_task2B,
                          save_figures=True )
